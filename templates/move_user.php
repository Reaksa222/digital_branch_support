...
if (isset($_POST['search'])) {
    ...
    $sql = "SELECT * FROM summary WHERE display_name LIKE ? OR brunch LIKE ? OR position LIKE ? ";
...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    if ($stmt->execute()) {
        header("Location: move_user.php?st=delete-success");
        exit;
    } else {
        header("Location: move_user.php?st=delete-error");
        exit;
    }
}
                                    ...
                                    <?php if (!empty($searchResults)): ?>
                                        ...
                                        foreach ($searchResults as $row):
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a
                                                        href="../templates/edit_assessment.php?id=<?php echo $row['id']; ?>">Edit</a>
                                                </td>
                                                <td>
                                                    <a
                                                        href="../templates/move_user.php?delete=<?php echo $row['id']; ?>">Delete</a>
                                                </td>
