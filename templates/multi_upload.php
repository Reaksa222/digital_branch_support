    ...
    <div class="container">
        ...
        <div class="container2">
                <div class="back_button"><a href="../Admin Dashboard/admin.php" class="back-button"><i
                    class="fa fa-chevron-circle-left" style="font-size:28px">Back</i></a>
                </div>
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <div class="card">
                            ...
                            <div class="form-group">
                                <!-- <input type="submit" name="submit" value="Go Upload_text" class="btn btn-change"> -->
                                <button class='btn btn-change' type="submit" name="submit" ><a href="../templates/input_upload.php" style="color: white; text-decoration: none;">
                                    Go Upload_text</a></button> 
                            </div>
                            <div class="card-body">
