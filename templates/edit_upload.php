...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $sql = "SELECT title, drop_file,description, short_description FROM tbl_get WHERE id = ?";
    ...
    if ($stmt->execute()) {
        ...
        if ($stmt->num_rows > 0) {
            $stmt->bind_result($title, $dropFile,$description, $shortDescription);
            $stmt->fetch();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE tbl_get SET title = ?, drop_file = ?,description =? ,short_description = ? WHERE id = ?";
    $stmt = $conn->prepare($sql);
    ...
    $stmt->bind_param("ssssi", $title, $dropFile,$description, $shortDescription, $id);
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-list">
                            ...
                            <select name="drop_file" class="form-control" id="drop_file">
                                <option value="Team Card Payment" <?php if ($dropFile === "Team Card Payment")
                                    echo "selected"; ?>>Team Card Payment</option>
                                <option value="Team ATM" <?php if ($dropFile === "Team ATM")
                                    echo "selected"; ?>>Team ATM
                                </option>
                                <option value="Team Digital Branch" <?php if ($dropFile === "Team Digital Branch")
                        ...
                        <textarea id="myTextarea"
                            name="short_description"><?php echo $shortDescription; ?> </textarea>
