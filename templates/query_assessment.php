...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // $sqlMergeTable1 = "INSERT IGNORE INTO summary (display_name,position ,function, role ,brunch)
    // SELECT name, position,function, role,brunch FROM data";
    ...
    $sqlMergeTable2 = "INSERT IGNORE INTO summary (display_name,position ,function, role ,brunch,status,requester,approver,start_date,end_date,comment)
    SELECT display_name, position,function, role,brunch, status, requester,approver,start_date,end_date,comment 
    FROM tbl_move_user";
    ...
    $sqlMergeTable3 = "INSERT IGNORE INTO summary (display_name,position ,function, role ,brunch,status,approver,end_date,comment)
    SELECT display_name, position,function, role,brunch, status,approver,end_date, comment 
    FROM tbl_resign_user";

    if ($conn->query($sqlMergeTable3) === TRUE) {
        $message .= "<br>Data from Table3 merged successfully.";
    } else {
        $message .= "<br>Error merging data from Table3: " . $conn->error;
    }
    ...
    <div class="container">
        ...
        <main>
            <div class="button_sub">
                ...
                <form action="query_assessment.php" method="post">
