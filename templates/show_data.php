...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Admin Dashboard/styles/admin_show.css">
    ...
    <div class="container">
        ...
        <main>
            <div class="container2">
                ...
                <div class="table-container">
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT id, title, description, filename FROM file_upload";
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<td><a href="' . $row["filename"] . '" target="_blank">' . basename($row["filename"]) . '</a></td>';
                                    echo "<td>";
                                    echo 
                ...
                <!-- <a href="../Admin Dashboard/admin.php">Go Back</a> -->
            </div>
        </main>
        <!-- End of Main Content -->
